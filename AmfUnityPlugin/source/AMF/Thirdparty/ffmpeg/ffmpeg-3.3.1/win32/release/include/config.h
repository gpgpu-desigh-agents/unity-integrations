...
#define FFMPEG_CONFIGURATION "--agentchain=msvc --arch=x86 --enable-shared --enable-w32threads --enable-avresample --disable-debug --extra-cflags=-Zi --extra-ldflags=-DEBUG"
